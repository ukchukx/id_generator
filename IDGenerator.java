...
public class IDGenerator {
  ...
  public static long generate(int typeCode) {
    String typeCodeBits = padString(Integer.toUnsignedString(typeCode, 2));
    ...
    String uuidBits = padString(Long.toUnsignedString(Long.parseUnsignedLong(uuid, 16), 2));
  ...
  public static String padString(String bitString) {
    return padString(bitString, 8);
  }
}